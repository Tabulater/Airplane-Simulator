...
cp bin/airplane-simulator $APP_DIR/usr/bin/
cp airplane-simulator.desktop $APP_DIR/usr/share/applications/
cp airplane-simulator.png $APP_DIR/usr/share/icons/hicolor/128x128/apps/

sudo chown root:root -R $APP_DIR
sudo chmod 0755 $APP_DIR/usr/bin/airplane-simulator
sudo chmod 0755 $APP_DIR/usr/share/applications/airplane-simulator.desktop
sudo chmod 0755 $APP_DIR/usr/share/icons/hicolor/128x128/apps/airplane-simulator.png
